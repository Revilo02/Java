...
public class LatogatoTest {
	...
	public void setUp() {
		...
		k=new Konyvek("Relativitás elmélet","Einstein","Tudományos",1940);
		k2=new Konyvek("Relativitás elmélet visszavág","Einstein","Tudományos",1940);
	}
	@Test
	public  void testToString() {
	Assert.assertEquals("171, Tesztalany, nincsen mert bezártuk",l1.toString());
	}
	@Test
