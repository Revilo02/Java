...
class Parancsok {
	...
	protected static void SPeopleadd() {
		...
		System.out.println("Kérem adja meg a sportoló nevét: ");
		String nev = s.nextLine();
		System.out.println("Kérem adja meg a sportoló születésének évét: ");
		String szev = s.nextLine();
		System.out.println("Kérem adja meg a sportoló email címét: ");
		String email = s.nextLine();
		System.out.println("Kérem adja meg a sportoló edzési szintjét: ");
	...
	protected static void Teacheradd() {
		Scanner s = new Scanner(System.in);
		System.out.println("Kérem adja meg a oktató nevét: ");
		String nev = s.nextLine();
		System.out.println("Kérem adja meg a oktató születésének évét: ");
		String szev = s.nextLine();
		System.out.println("Kérem adja meg a oktató email címét: ");
		String email = s.nextLine();
		System.out.println("Kérem adja meg a oktató értékelését: ");
	...
	protected static void Oktatoszerint() {
		Scanner s = new Scanner(System.in);
		System.out.println("Kérem adja meg a oktató nevét akire rá szeretne keresni: ");
		String nev = s.nextLine();
	...
	protected static void Sportoloszerint() {
		Scanner s = new Scanner(System.in);
		System.out.println("Kérem adja meg a sportoló nevét akire rá szeretne keresni: ");
		String nev = s.nextLine();
	...
	protected static void Sportszerint() {
		Scanner s = new Scanner(System.in);
		System.out.println("Kérem adja meg a sport nevét amire rá szeretne keresni: ");
		String nev = s.nextLine();
	...
	protected static void Idopontszerint() {
		Scanner s = new Scanner(System.in);
		System.out.println("Kérem adja meg a napot amire rá szeretne keresni: ");
	...
	protected static int SmodifyID() {
		...
		System.out.println("Kérem adja meg a módosítandó sportoló nevét: ");
		...
		System.out.println("Kérem adja meg a sportoló ID-ját");
	...
	protected static void SModify() {
		...
		while(true) {
			System.out.println("Adja meg azt amit majd Jenni beír");
			String v1=s.nextLine();
			if(v1.equals("n")){
				System.out.println("Kérem adja meg az új nevet: ");
				String ujnev=s.nextLine();
				sportolo.get(i).setNev(ujnev);
				break;
			}
			else if(v1.equals("s")){
				System.out.println("Kérem adja meg az új születési évét: ");
				int ujev=s.nextInt();
				sportolo.get(i).setSzev(ujev);
				break;
			}
			else if(v1.equals("e")){
				System.out.println("Kérem adja meg az új email címet: ");
